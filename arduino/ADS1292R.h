...
const int ADS1292_START_PIN = 7;
const int ADS1292_PWDN_PIN = 6;
...
class ads1292r
{
  public:
    ...
    static void ads1292_Enable_Test_Signal(void);
    static void ads1292_Set_Sample_Rate(int);
    static void ads1292_Enable_Input_3 (void);
    static void ads1292_Change_Channel_Input (byte input, byte gain);
    static void start (void);
    static void ads1292_Reg_Read_All (void);
    static void ads1292_Offset_Calib(void);
 };
